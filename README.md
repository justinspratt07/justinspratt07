...
| [Spring Boot Grading Microservice](https://github.com/justinspratt07/spring-boot-grading-microservice) | Java REST API with validation, service-layer logic, Maven, JUnit 5, and MockMvc tests. |
| [Pizza Shop](https://github.com/justinspratt07/Pizza-Shop) | Team-built Flask ordering application with customer and manager workflows, REST endpoints, checkout processing, testing, and HTTPS deployment planning. |
